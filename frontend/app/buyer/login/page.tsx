  ...
  return (
    <div className="app-shell">
      <section className="mx-auto max-w-xl">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#2d6a4f]">Buyer login</p>
          <h1 className="mt-2 text-4xl font-black">Enter customer account</h1>
          <p className="mt-2 text-[#6d5145]">Use the buyer account created before checkout.</p>
        </div>
        ...
        <form className="app-card mt-6 grid gap-5 p-6" onSubmit={submit}>
          ...
          <label>
            ...
            <input className="field" name="identifier" placeholder="9876501234 or buyer@example.com" />
          ...
          <button className="primary-button w-full bg-[#2d6a4f]" disabled={busy} type="submit">
            {busy ? "Logging in..." : "Login as buyer"}
          </button>
          <Link className="text-center text-sm font-bold text-[#2d6a4f]" href="/buyer/register">
